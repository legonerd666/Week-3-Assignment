...
public class Old_Main{
    ...
    private static JPanel studentDataP;
    ...
    public static void main(String[] args) {
        ...
        studentDataPanel(frame, pGBC, fGBC);
    ...
    public static void studentDataPanel(JFrame frame, GridBagConstraints pGBC, GridBagConstraints fGBC){
        ...
        pGBC.gridwidth = 2;
        pGBC.fill = GridBagConstraints.HORIZONTAL;
        studentDataP.add(nameL, pGBC);

        JLabel idL = new JLabel("ID: " + "getID");
        pGBC.gridx = 0;
        pGBC.gridy = 1;
        pGBC.gridwidth = 2;
        pGBC.fill = GridBagConstraints.HORIZONTAL;
        studentDataP.add(idL, pGBC);

        JLabel DOBL = new JLabel("Date of Birth: " + "getDOB");
        pGBC.gridx = 0;
        pGBC.gridy = 2;
        pGBC.gridwidth = 2;
        pGBC.fill = GridBagConstraints.HORIZONTAL;
        studentDataP.add(DOBL, pGBC);

        JLabel gradeLevelL = new JLabel("Grade Level: " + "getGradeLevel");
        pGBC.gridx = 0;
        pGBC.gridy = 3;
        pGBC.gridwidth = 2;
        pGBC.fill = GridBagConstraints.HORIZONTAL;
        studentDataP.add(gradeLevelL, pGBC);

        JLabel takenClassesL = new JLabel("Taken Classes: " + "getTakenClasses");
        pGBC.gridx = 0;
        pGBC.gridy = 4;
        pGBC.gridwidth = 2;
        pGBC.fill = GridBagConstraints.HORIZONTAL;
        studentDataP.add(takenClassesL, pGBC);

        JLabel overallGradeL = new JLabel("Overall Grade: " + "getOverallGrade");
        pGBC.gridx = 0;
        pGBC.gridy = 5;
        pGBC.gridwidth = 2;
        pGBC.fill = GridBagConstraints.HORIZONTAL;
        studentDataP.add(overallGradeL, pGBC);
